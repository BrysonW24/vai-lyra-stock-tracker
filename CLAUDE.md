...
- `DATA-ECONOMICS.md` - measured usage + free-tier runway (DB growth, call volumes, tripwires). Re-measure via its Refresh section when a new writer joins the nightly or roughly quarterly.
