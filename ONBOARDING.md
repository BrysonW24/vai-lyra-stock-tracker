...
| [public/setup-companion.html](public/setup-companion.html) | The human, in the app | Same companion served at `/setup-companion.html` as an in-app resource - keep in sync with the docs copy |
