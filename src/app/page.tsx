        ...
        <section className="terminal-panel overflow-hidden rounded-md">
            <div className="flex items-center justify-between border-b border-[#1b2530] px-3 py-3">
              <div>
                ...
                <p className="mt-1 font-mono text-xs text-[#a8b5c2]">Ranked backend signal outputs</p>
              </div>
                ...
                <tbody className="divide-y divide-[#1b2530]">
                  {strongSignals.map((signal) => (
                    <tr className="font-mono text-[#dbe5ee] hover:bg-[#101720]" key={signal.symbol}>
                      ...
                      <td className="px-3 py-2 text-lg font-semibold">{signal.score}</td>
        ...
        <section className="grid gap-3 xl:grid-cols-[0.85fr_1.15fr]">
          <div className="terminal-panel overflow-hidden rounded-md">
            <div className="border-b border-[#1b2530] px-3 py-3">
              ...
              <p className="mt-1 font-mono text-xs text-[#a8b5c2]">Backend watchlist overlay state</p>
            </div>
          ...
          <div className="terminal-panel overflow-hidden rounded-md">
            <div className="flex items-center justify-between border-b border-[#1b2530] px-3 py-3">
              <div>
                ...
                <p className="mt-1 font-mono text-xs text-[#a8b5c2]">Since last scan</p>
              </div>
        ...
        <section className="terminal-panel overflow-hidden rounded-md">
          <div className="flex items-center justify-between border-b border-[#1b2530] px-3 py-3">
            <div>
              ...
              <p className="mt-1 font-mono text-xs text-[#a8b5c2]">Displays backend portfolio overlay values</p>
            </div>
          ...
          <div className="grid gap-px bg-[#1b2530] md:grid-cols-2 xl:grid-cols-4">
            {portfolioRows.map((holding) => (
              <div className="bg-[#0d1117] p-3" key={holding.symbol}>
                <div className="flex items-start justify-between gap-3">
                  <div>
                    <p className="font-mono text-lg font-semibold text-[#eef3f8]">{holding.symbol}</p>
                    <p className="font-mono text-xs text-[#8190a0]">Weight {formatPercent(holding.portfolioWeight)}</p>
                  </div>
