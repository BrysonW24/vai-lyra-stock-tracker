  ...
  return (
    <section className="terminal-panel overflow-hidden rounded-md">
      <div className="flex items-center justify-between border-b border-[#1b2530] px-4 py-3">
        <p className="text-[11px] font-semibold uppercase tracking-[0.16em] text-[#8190a0]">Price · candles</p>
        <span className="font-mono text-xs text-[#dbe5ee]">{formatCurrency(last.close)}</span>
      </div>
      ...
      <div className="relative h-[var(--ch)] overflow-hidden" style={{ ['--ch' as string]: `${height}px` }}>
        ...
        <div className="pointer-events-none absolute right-2 top-1 rounded border border-[#263241] bg-[#0d141c]/90 px-2 py-0.5 font-mono text-[10px] text-[#a8b5c2]">
