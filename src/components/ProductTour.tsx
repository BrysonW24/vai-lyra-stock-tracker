...
const STEPS: TourStep[] = [
  ...
  { icon: Bell, title: 'Alerts', body: 'Get strong setups and risk flags delivered to Telegram or WhatsApp, with quiet hours and per-ticker control. Set it up in Account.', href: '/account', hrefLabel: 'Set up alerts' },
