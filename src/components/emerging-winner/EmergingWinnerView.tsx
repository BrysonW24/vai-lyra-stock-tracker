    ...
    <article className={`rounded-2xl border border-white/10 bg-white/[0.04] backdrop-blur ${d.surfaced ? '' : 'opacity-70'}`}>
      ...
      <button type="button" onClick={() => setOpen((o) => !o)} className="w-full px-4 py-3 text-left">
        <div className="mb-1.5 flex items-center gap-2">
          ...
          <span className="text-[10px] text-white/40">trained on real outcomes · survivor-biased corpus</span>
        </div>
    ...
    <div className="mb-5 rounded-xl border border-white/10 bg-white/[0.03]">
      ...
      {open && (
        <div className="space-y-3 border-t border-white/10 px-4 py-3 text-[12.5px] leading-relaxed text-white/65">
          <p>
            <span className="font-semibold text-white/85">Today: real historical outcomes, with a known
            bias.</span>{' '}
          ...
          <p>
            <span className="font-semibold text-white/85">The backtest evidence, exactly.</span>{' '}
          ...
          <p>
            <span className="font-semibold text-white/85">What is still illustrative or missing.</span>{' '}
